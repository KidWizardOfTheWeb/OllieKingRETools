...
def bcLoadModel(data, mdlList):
    ...
    anims = []
    dataTemp = None
    # WARNING: ONLY UNCOMMENT THE FOR-LOOP BELOW IF YOU ARE USING THE PROPER FILESYSTEM FROM OLLIE KING AND HAVE ALL THE FILES. This is a very intensive process to get every animation onto the model.
    # You've been warned...
    # for i in range (613):
