...
def registerNoesisTypes():
    handle = noesis.register("Ollie King Audience models (Arcade)",".mdb")
...
def bcLoadModel(data, mdlList):
    ...
    # TODO: handle geisha and flag parenting info and bone order
    parent_info = [-1, 5, 1, 5, 3, 0, 5, 6, 7, 6, 9]				# default parent info for audience skeletons
    ...
    count = 0
    aud_boneNum = [0, 5, 6, 7, 8, 9, 10, 1, 2, 3, 4] # Possibly need this to reorder bones in order to handle anims?
    for a in range(entries):
        ...
        if entry_type == 0x112:							# bone info
            ...
            bone_num += 1
            # TODO: figure out proper parenting/order issues to handle animations
    ...
    anims = []
    dataTemp = None
    # TODO: finish editing loop to read AUDIENCE ONLY ANIMATIONS
    # You've been warned...
    # for i in range (35):
    ...
    # This loop and the next method used will be updated later to choose between either option in a GUI.
